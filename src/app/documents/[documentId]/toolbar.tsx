  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="h-7 min-w-7 shrink-0 flex flex-col items-center justify-center rounded-sm hover:bg-neutral-300/80 px-1.5 overflow-hidden text-sm">
    ...
    <div className="flex items-center gap-x-0.5">
      ...
      {isEditing ? (
        <input
          ...
          className="h-7 w-10 text-center rounded-sm border border-neutral-400 bg-transparent focus:outline-none focus:ring-0"
        />
      ) : (
        <button
          onClick={() => {
          ...
          className="h-7 w-10 text-center rounded-sm border border-neutral-400 bg-transparent cursor-text"
        >
          {currentFontSize}
        </button>
      )}
...
const HighlightColorButton = () => {
  ...
  // const value = editor?.getAttributes("textStyles").color || "#000000";
...
export const Toolbar = () => {
  ...
  return (
    <div className="bg-[#F1F4F9] px-2.5 py-0.5 rounded-[24px] min-h-[40px] flex items-center gap-x-0.5 overflow-x-auto">
      ...
      <div className="mx-2 h-6 w-px bg-neutral-400" />
      <FontFamilyButton />
      <div className="mx-2 h-6 w-px bg-neutral-400" />
      <HeadingLevelButton />
      <div className="mx-2 h-6 w-px bg-neutral-400" />
